...
namespace bytebank_ATENDIMENTO.bytebank.Atendimento
{
    public class ByteBankAtendimento
    {
        ...
        private void ExibirListaDeContas(List<ContaCorrente> contasPorAgencia)
        {
            ...
            {
                foreach (var contaItem in contasPorAgencia)
                {
                    Console.WriteLine(contaItem.ToString());
                }
            }
        }
        ...
        private void RemoverConta()
        {
            ...
            foreach (var contaItem in _listaDeContas)
            {
                if (contaItem.Conta.Equals(numeroConta))
                {
                    conta = contaItem;
                }
            }
